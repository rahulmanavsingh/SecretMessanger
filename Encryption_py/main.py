...
def main_screen():
    ...
    Label(text="Enter the text for encryption and dycryption",fg="black",font=("calbri",13)).place(x=10,y=10)
    text1=Text(font="Roboto 20",bg="white",relief=GROOVE,wrap=WORD,bd=0)
    text1.place(x=10,y=50,width=355,height=100)

    Label(text="Enter the secret key for encryptiona and decryption",fg="black",font=("calibri",13)).place(x=10,y=170)
    code=StringVar()
